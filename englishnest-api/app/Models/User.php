...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    */
    ...
    public function historialContrasenas() {
        return $this->hasMany(ContrasenaHistorial::class, 'usuario_id');
    }

    public function suscripcionActiva() {
        return $this->hasOne(Suscripcion::class, 'usuario_id')->where('estado', 'activa');
    }


    public function sendPasswordResetNotification($token): void
    {
        // Al llamar a notify, usará la configuración que pusimos en el AppServiceProvider
